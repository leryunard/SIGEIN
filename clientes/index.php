                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                foreach ($clientes_datos as $cliente_dato) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="https://wa.me/503<?php echo $celular_cliente; ?>"
                                        ...
                                        <td>
                                            <center><?php echo $email_cliente; ?></center>
                                        </td>
                                        <td>
                                            <center>
                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <small style="color:red;display:none;"
                                                                                       id="lbl_cliente<?php echo $id_cliente; ?>">*Este
                                                                                    campo es requerido</small>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="">Nit Cliente</label>
                                                                                <input type="text"
                                                                                       id="nit_cliente<?php echo $id_cliente; ?>"
                                                                                       value="<?php echo $nit_cliente; ?>"
                                                                                       class="form-control" required>
                                                                                <small style="color:red;display:none;"
                                                                                       id="lbl_nit<?php echo $id_cliente; ?>">*Este
                                                                                    campo es requerido</small>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="email"
                                                                                       id="email_cliente<?php echo $id_cliente; ?>"
                                                                                       value="<?php echo $email_cliente; ?>"
                                                                                       class="form-control" required>
                                                                                <small style="color:red;display:none;"
                                                                                       id="lbl_email<?php echo $id_cliente; ?>">*Este
                                                                                    campo es requerido</small>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number"
                                                                                       ...
                                                                                       class="form-control" required>
                                                                                <small style="color:red;display:none;"
                                                                                       id="lbl_celular<?php echo $id_cliente ?>">*Este
                                                                                    campo es requerido</small>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="">Nombre del Cliente</label>
                                                                                <span id="nombre_cliente<?php echo $id_cliente; ?>"><?php echo $nombre_cliente; ?></span>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="">Nit Cliente</label>
                                                                                <span id="nit_cliente<?php echo $id_cliente; ?>"><?php echo $nit_cliente; ?></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="">Email</label>
                                                                                <span id="email_cliente<?php echo $id_cliente; ?>"><?php echo $email_cliente; ?></span>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="">Celular</label>
                                                                                <span id="celular_cliente<?php echo $id_cliente; ?>"><?php echo $celular_cliente; ?></span>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="modal-footer justify-content-between">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger"
                                                                            id="btn_delete<?php echo $id_cliente; ?>">
                                                                        Eliminar Cliente
                                                                    </button>
                                                                </div>
                                                            </div>
