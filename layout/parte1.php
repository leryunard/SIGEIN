  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
       <table>
       <h1><a href="../index.php" class="nav-link">  <p style=color:black><strong> SISTEMA DE INVENTARIO LUBRICANTES Y ACCESORIOS ESPAÑA </strong> </a></p></h1>
       </table>
      </li>
    </ul>
...
-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light"> <p style= color:with><strong> INVENTARIO</strong></span> </p>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" style="background-color:#D40404;">
