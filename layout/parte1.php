  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><p style="color: red;"> <strong>SISTEMA DE INVENTARIO LUBRICANTES Y ACCESORIOS ESPAÑA</p></strong></a>
      </li>
    </ul>
...
-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><strong> Estas en el Inventario</strong></span>
    </a>
