  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Detalles de la Venta Número: <?php echo $numero_de_la_venta;?></h1>
          </div><!-- /.col -->
          ...
          <div class="col-md-9">
            ...
            <div class="card card-outline card-primary">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        <center><a href="<?php echo $URL.'/ventas/index.php';?>" class="btn btn-primary btn-block form-control">Regresar</a></center>
                      </div>
                  </div>
                  <!-- /.card-body -->
                </div>  
