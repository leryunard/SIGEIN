...
<div class="modal fade" id="modal_cliente_venta<?php echo $id_venta?>">
                          <div class="modal-dialog modal-sm">
                               ...
                               <td>
                                ...
                                <a href="delete.php?id=<?=$id_venta;?>&num_venta=<?php echo $numero_vent;?>" class="btn btn-danger"><i class="fa fa-trash"></i> Eliminar</a>
                                <a href="factura.php?id=<?=$id_venta;?>&num_venta=<?php echo $numero_venta;?>" class="btn btn-secondary"><i class="fa fa-print"></i> Imprimir</a>
                                </center>
                              </td>
