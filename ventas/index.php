                        ...
                        <?php 
                          ...
                          foreach ($ventas_datos as $venta_dato){
                            ...
                            <tr>
                               ...
                               <td><center>
                               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-productos-venta<?php echo $id_venta;?>">
                                  Productos
                                </button>
                                <div class="modal fade" id="modal-productos-venta<?php echo $id_venta?>">
                                  <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                      <div class="modal-header" style="background-color: aqua;">
                                        <h4 class="modal-title">Productos de la venta: <?php echo $venta_dato['num_venta'];?></h4>
                               ...
                               <td><center><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_cliente_venta<?php echo $id_venta;?>">
...
<div class="modal fade" id="modal_cliente_venta<?php echo $id_venta?>">
                          <div class="modal-dialog modal-sm">
                                    ...
                                    ?>
                                      <div class="modal-body">
                                          <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_cliente" class="form-control" disabled value="<?php echo $nombre_cliente;?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="">Documendo de Identidad</label>
                                            <input type="text" name="documento_identidad" class="form-control" disabled value="<?php echo $nit_cliente;?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="">Celular</label>
                                            <input type="text" name="celular_cliente" class="form-control" disabled value="<?php echo $celular_cliente;?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="">Correo Electronico</label>
                                            <input type="email" name="email_cliente" class="form-control" disabled value="<?php echo $email_cliente;?>">
                                            <hr>
                                          </div>
                                      </div>
                                        <div class="modal-footer justify-content-between">
                               ...
                               <td>
                                <center>
                                <a href="show.php?id=<?=$id_venta;?>" class="btn btn-info"><i class="fa fa-eye"></i> Ver Detalle</a>
                                <a href="delete.php?id=<?=$id_venta;?>&num_venta=<?php echo $numero_venta;?>" class="btn btn-danger"><i class="fa fa-trash"></i> Eliminar</a>
                                <a href="factura.php?id=<?=$id_venta;?>&num_venta=<?php echo $numero_venta;?>" class="btn btn-secondary" target="_blank"><i class="fa fa-print"></i> Imprimir</a>
                                </center>
                              </td>
